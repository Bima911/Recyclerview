package com.bimarandy.recyclerview.adapter
...
import com.bimarandy.recyclerview.databinding.ListItemPemainBinding
import com.bimarandy.recyclerview.model.Pemain

class AdapterTemBola (private val context : Context,
                      private var data : List<Pemain>?,
                      private val itemclick: OnClickListener)
            : RecyclerView.Adapter<AdapterTemBola.ViewHolder>() {
